...
namespace Traffic_ASP_MVC.Controllers
{
    ...
    {
        private readonly Traffic_TimeSlots_Context _context;

        public TimeSlotsController(Traffic_TimeSlots_Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.TimeSlots != null ? 
                          ...
                          Problem("Entity set 'Traffic_TimeSlots_Context.TimeSlots'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,SlotName")] TimeSlots timeSlots)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SlotName")] TimeSlots timeSlots)
        {
            if (id != timeSlots.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Traffic_TimeSlots_Context.TimeSlots'  is null.");
            }
            var timeSlots = await _context.TimeSlots.FindAsync(id);
            if (timeSlots != null)
            {
